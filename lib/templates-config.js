...
export const TEMPLATES = {
  static: {
    ...
    overview: [
      ...
      { row: 4,  field: 'Idea Name',           kind: 'text', required: true },
      ...
      { row: 11, field: 'Ratio Format(s)',     kind: 'multiselect', options: 'ratioFormats' },
      { row: 12, field: 'Ad Platform',         kind: 'dropdown', options: 'staticVideoAdPlatform' },
    ...
    creative: [
      { row: 1, field: 'File Name',      kind: 'text', required: true },
  ...
  video: {
    ...
    overview: [
      ...
      { row: 12, field: 'Ratio Format(s)',     kind: 'multiselect', options: 'ratioFormats' },
      { row: 13, field: 'Ad Platform',         kind: 'dropdown', options: 'staticVideoAdPlatform' },
  ...
  copy: {
    ...
    overview: [
      { row: 1,  field: 'AI Allowed?',         kind: 'dropdown', options: 'aiAllowed' },
      { row: 2,  field: 'Idea Name',           kind: 'text', required: true },
      ...
      { row: 7,  field: 'Ad Platform',         kind: 'dropdown', options: 'bodyCopyAdPlatform' },
    ...
    creative: [
      { row: 1, field: 'Name',           kind: 'text', required: true },
