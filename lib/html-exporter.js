...
function renderRun(r) {
  ...
  let bold = false, italic = false, underline = false, sizePt = null, colorHex = null;
  if (rPr) {
...
function renderTable(tbl) {
  ...
  return `<table style="border-collapse:collapse;width:100%;table-layout:fixed;margin:0 0 16pt 0">${colgroup}${rows}</table>`;
}
